    ...
    switch (state) {
        ...
        case MessageState::Sending: {
            ...
            state = MessageState::Sending;
            {
                ...
                request = std::make_unique<Socket::Request>(Socket::Request::forSend(ptr, length, fd, this));
        ...
        case MessageState::Receiving: {
            ...
            receive.resize(receive.size() + chunkSize);
            request = std::make_unique<Socket::Request>(Socket::Request::forRecv(receive.data() + receiveBufferOffset, static_cast<int64_t>(chunkSize), request->fd, this));
